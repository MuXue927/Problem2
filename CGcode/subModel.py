...
class SubModel:
    ...
    def __post_init__(self):
        ...
        # demands会随着主模型的优化而更新，所以需要检查demands中是否存在当前经销商和SKU的组合
        self.require_skus = {sku_id for sku_id in self.data.available_skus_to_dealer(self.fact_id, self.dealer_id)
                             if (self.dealer_id, sku_id) in self.demands}
        ...
        #     self.d_xs[sku_id] <= self.demands[self.dealer_id, sku_id]
